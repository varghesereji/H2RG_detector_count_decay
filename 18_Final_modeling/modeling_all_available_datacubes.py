...
#                print('channel',channel,'p found',P,'initial p',P_ini,'error',perr)
    ...
    #er_P[channel] = p_err
    np.save('..//22_Simulation/new_count_{}.npy'.format(channel),Count_new)
    np.save('..//22_Simulation/new_pvs_{}.npy'.format(channel),p_values)
    np.save('../22_Simulation/new_p_err_{}.npy'.format(channel),p_err)
